...
Note that to use digital inputs (binary sensors) and relays (switches) of your Global Cache device you can use the [gc100 component](https://home-assistant.io/components/gc100) and platforms.
